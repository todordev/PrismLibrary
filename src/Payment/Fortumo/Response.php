...
namespace Prism\Library\Prism\Payment\Fortumo;
...
class Response
{
     ...
     * );
     *
     * $response = new Prism\Library\Prism\Payment\Fortumo\Response($data);
     * </code>
     *
     * @param array $data
     */
     ...
     * );
     *
     * $response = new Prism\Library\Prism\Payment\Fortumo\Response();
     * $response->bind($data);
     * </code>
     *
     * @param array $data
