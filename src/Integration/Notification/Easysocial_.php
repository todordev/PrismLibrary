...
class EasySocial implements NotificationInterface
{
     ...
     * $content = "....";
     *
     * $notification = new Prism\Library\Prism\Integration\Notification\EasySocial($userId, $content);
     * </code>
     *
     ...
     *
     * <code>
     * $notification = new Prism\Library\Prism\Integration\Notification\EasySocial();
