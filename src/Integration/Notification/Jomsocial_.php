...
class JomSocial implements NotificationInterface
{
     ...
     * $content = "....";
     *
     * $notification = new Prism\Library\Prism\Integration\Notification\JomSocial($userId, $content);
     * </code>
     *
     ...
     *
     * <code>
     * $notification = new Prism\Library\Prism\Integration\Notification\JomSocial();
