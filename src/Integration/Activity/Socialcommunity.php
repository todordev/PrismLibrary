...
class Socialcommunity implements ActivityInterface
{
     ...
     * $content = "...";
     *
     * $activity = new Prism\Library\Prism\Integration\Activity\Socialcommunity($userId, $content);
     * </code>
     *
     ...
     *
     * <code>
     * $activity = new Prism\Library\Prism\Integration\Activity\Socialcommunity();
     * $id = $activity->getId();
     * </code>
     *
     * @return int $id
