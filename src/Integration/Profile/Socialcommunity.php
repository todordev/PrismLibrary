...
class Socialcommunity extends TableImmutable implements ProfileInterface, ProfileMapper
{
     ...
     * $userId = 1;
     *
     * $profile = new Prism\Library\Prism\Integration\Profile\Socialcommunity(\JFactory::getDbo());
     * </code>
     *
     ...
     * $ids = array(1, 2, 3, 4);
     *
     * $profiles = new Prism\Library\Prism\Integration\Profile\Socialcommunity(\JFactory::getDbo());
