...
trait FetchMethods
{
     ...
     * $fieldId       = new Prism\Library\Prism\Database\Request\Field(['column' => 'id', 'table' => 'a']);
     * $fieldContent  = new Prism\Library\Prism\Database\Request\Field(['column' => 'content', 'table' => 'a']);
     *
     * $fields  = new Prism\Library\Prism\Database\Request\Fields;
     * $fields
     *    ->addField($fieldId)
     *    ->addField($fieldContent);
     *
     * // Prepare database request.
     * $databaseRequest = new Prism\Library\Prism\Database\Request\Request;
     ...
     * <code>
     * // Prepare conditions.
     * $userId      = new Prism\Library\Prism\Database\Request\Condition(['column' => 'user_id', 'value' => $userId, 'operator' => '=']);
     * $createAt    = new Prism\Library\Prism\Database\Request\Condition(['column' => 'created_at', 'value' => '2012-10-12', 'operator' => '=']);
     *
     * $conditions  = new Prism\Library\Prism\Database\Request\Conditions;
     * $conditions
     *  ->addCondition($userId)
