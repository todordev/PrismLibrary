...
abstract class StringHelper
{
     ...
     *
     * <code>
     * $hash = Prism\Library\Prism\Utilities\StringHelper::generateRandomString(32, "GEN");
     *
     * echo $hash;
     * </code>
     *
     ...
     * );
     *
     * $amount = Prism\Library\Prism\Utilities\StringHelper::getAmount(100, GBP, $options);
     *
     * echo $amount;
     * </code>
     *
     ...
     *
     * echo Prism\Library\Prism\Utilities\StringHelper:clean($content);
     * </code>
     *
     ...
     *
     * echo Prism\Library\Prism\Utilities\StringHelper::substr($content, $offset, $length);
     * </code>
     *
     * @param string $content
     * @param int $offset
     ...
     *
     * $post = Prism\Library\Prism\Utilities\StringHelper::parseNameValue($content);
     * </code>
     *
     * @param string $content
     *
     ...
     * $alias = Prism\Library\Prism\Utilities\StringHelper::stringUrlSafe($name);
     * </code>
     *
     * @param string $string
     *
     ...
     * $name = 'John Dow';
     *
     * $alias = Prism\Library\Prism\Utilities\StringHelper::generateMd5Hash($name, $id);
     * </code>
     *
     * @param string $name
     * @param mixed $value
     ...
     * );
     *
     * $urlParameters = Prism\Library\Prism\Utilities\StringHelper::generate($params);
     * </code>
     *
     * @param array $params
     *
     ...
     *
     * Prism\Library\Prism\Utilities\StringHelper::stripTagsAndSpaces($htmlString);
     * </code>
     *
     * @param $string
     * @return string
