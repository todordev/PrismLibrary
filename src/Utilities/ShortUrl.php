...
class ShortUrl
{
     ...
     * );
     *
     * $urlService = new Prism\Library\Prism\ShortUrl($url, $options);
     * </code>
     *
     * @param string $url
     * @param array $options
     ...
     * );
     *
     * $urlService = new Prism\Library\Prism\Utilities\ShortUrl($url);
     ...
     * );
     *
     * $urlService = new Prism\Library\Prism\Utilities\ShortUrl($url, $options);
     *
